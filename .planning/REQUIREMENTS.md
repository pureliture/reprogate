...
- [x] **HOOK-05**: PreToolUse hook — governance capture (standard 프로파일 이상에서 활성). OPA 평가는 `git commit` 시만 hard gate; 실행 중은 advisory.
- [x] **HOOK-06**: PostToolUseFailure hook — gate 실패를 `records/gate-failures/`에 자동 기록.
