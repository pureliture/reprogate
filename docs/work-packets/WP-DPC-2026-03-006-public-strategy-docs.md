...
- curate strategic content from prior discussion history
- add public-facing docs suitable for the external canonical repository
- link them into existing documentation surfaces

## 4. Out of Scope

- raw transcript migration
- public remote push
- broader contributor/process docs beyond the first strategy layer
